...
plt.xlabel('time')
plt.ylabel('value')
plt.title('Mass-Spring System Time Evolution, tend = ' + args.tend_relative + "pi, steps = " +args.steps)
plt.legend()
plt.grid()
...
plt.xlabel('position')
plt.ylabel('velocity')
plt.title('Mass-Spring System Phase Plot, tend = ' + args.tend_relative + "pi, steps = " +args.steps)
plt.legend()
plt.grid()
